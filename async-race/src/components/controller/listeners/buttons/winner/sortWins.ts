...
export default class SortWins extends Listener implements IEventElement {
  ...
  public callback(event: Event): void {
    ...
    if (child.classList.contains('display-none')) {
      ...
      document.querySelector('.time-head__arrow')?.classList.add('display-none');
      ...
      buttonRemove.updateWinner('wins', newOrder);
    }
  }
}
